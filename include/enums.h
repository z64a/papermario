...
enum ImgFXStateFlags {
    ...
    IMGFX_FLAG_REVERSE_ANIM         = 0x00000100, // animation plays backwards (from end to start)
    IMGFX_FLAG_ANIM_INIT            = 0x00000200,
    IMGFX_FLAG_ALPHA_CVG            = 0x00000400,
    IMGFX_FLAG_HOLD_DONE            = 0x00000800, // hold on endpoint when finished, prevents auto-disposal
    IMGFX_FLAG_ANIM_DONE            = 0x00001000,
    IMGFX_FLAG_USE_LIGHTING         = 0x00002000,
    IMGFX_FLAG_HOLDING              = 0x00004000, // animation is done and currently holding on last frame
...
enum ImgFXRenderResults {
    IMGFX_RENDER_RESULT_OK          = 0,
