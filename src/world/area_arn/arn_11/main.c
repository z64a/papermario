...
EvtScript N(EVS_Scene_MeetHeart) = {
    ...
    Call(SpeakToPlayer, NPC_TubbasHeart, ANIM_TubbasHeart_TalkAngry, ANIM_TubbasHeart_Idle, 0, MSG_CH3_00BF)
    Wait(10 * DT)
    Call(SetPlayerAnimation, ANIM_MarioW2_SpeakUp)
    Wait(40 * DT)
    Call(SpeakToPlayer, NPC_TubbasHeart, ANIM_TubbasHeart_TalkAngry, ANIM_TubbasHeart_Idle, 0, MSG_CH3_00C0)
    Call(SetPlayerAnimation, ANIM_Mario1_Idle)
    Wait(10 * DT)
    Call(SetPlayerAnimation, ANIM_MarioW3_ShakeHead)
    Wait(30 * DT)
    Call(SpeakToPlayer, NPC_TubbasHeart, ANIM_TubbasHeart_TalkAngry, ANIM_TubbasHeart_Idle, 0, MSG_CH3_00C1)
    Call(SetPlayerAnimation, ANIM_Mario1_Idle)
    Wait(20 * DT)
    Call(SetPlayerAnimation, ANIM_MarioW3_ShakeHead)
    Thread
    ...
    EndThread
    Wait(40 * DT)
    Call(SpeakToPlayer, NPC_TubbasHeart, ANIM_TubbasHeart_TalkAngry, ANIM_TubbasHeart_Idle, 0, MSG_CH3_00C2)
    Call(SetPlayerAnimation, ANIM_MarioW3_ShakeHead)
    Wait(10 * DT)
