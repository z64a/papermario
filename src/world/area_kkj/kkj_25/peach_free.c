...
EvtScript N(EVS_Scene_PeachBreaksFree) = {
    ...
    EndThread
    Call(SetNpcAnimation, NPC_Kammy_01, ANIM_BattleKammy_FlyRodStill)
    Call(SpeakToPlayer, NPC_Kammy_01, ANIM_BattleKammy_FlyRodTalk, ANIM_BattleKammy_FlyRodStill, 0, MSG_CH8_008F)
    Wait(10)
    ...
    Thread
        Call(SetNpcAnimation, NPC_Kammy_01, ANIM_BattleKammy_Broom)
    ...
    Thread
        ...
        Wait(5)
        Call(SetNpcAnimation, NPC_Kammy_02, ANIM_BattleKammy_Slump)
    EndThread
    Thread
    ...
    Call(SetNpcAnimation, NPC_Kammy_01, ANIM_BattleKammy_FlyStill)
    Wait(10)
    Call(SpeakToPlayer, NPC_Kammy_01, ANIM_BattleKammy_FlyTalk, ANIM_BattleKammy_FlyStill, 0, MSG_CH8_0092)
    Wait(10)
