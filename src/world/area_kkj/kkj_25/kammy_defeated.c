...
EvtScript N(EVS_Scene_KammyDefeated) = {
    ...
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, LVar0, LVar1, LVar2, 10)
    SetF(LVar0, 0)
    Loop(20)
    ...
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 110, 20, 3, 10)
    Wait(6)
    Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 100, 20, 3)
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 100, 20, 3, 15)
    Wait(6)
    Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 90, 20, 3)
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 90, 20, 3, 20)
    Wait(6)
    Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 110, 20, 3)
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 110, 20, 3, 25)
    Wait(6)
    Call(SetPlayerAnimation, ANIM_Mario1_UsePower)
    Loop(3)
        Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 100, 20, 3)
        PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 100, 20, 3, 30)
        Wait(6)
        Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 90, 20, 3)
        PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 90, 20, 3, 30)
        Wait(6)
        Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 110, 20, 3)
        PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 110, 20, 3, 30)
        Wait(6)
    EndLoop
