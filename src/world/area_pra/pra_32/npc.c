...
EvtScript N(EVS_Scene_CrystalKingAppears) = {
    ...
    Thread
        ...
        PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_SCATTER_MANY, LVar0, LVar1, LVar2, 10)
        Wait(20 * DT)
        PlayEffect(EFFECT_BIG_SNOWFLAKES, 0, LVar0, LVar1, LVar2)
        PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, LVar0, LVar1, LVar2, 7)
    EndThread
...
EvtScript N(EVS_Scene_BossDefeated) = {
    ...
    Call(GetNpcPos, NPC_CrystalKing_01, LVar0, LVar1, LVar2)
    Add(LVar1, 20)
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_SCATTER_FEW, LVar0, LVar1, LVar2, 40)
