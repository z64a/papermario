...
EvtScript N(EVS_Scene_RecieveStarBeam) = {
    ...
    Thread
        ...
        PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, LVar6, LVar7, LVar8, 10)
    EndThread
    Thread
    ...
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 10, 154, 88, 10)
    Wait(6)
    Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 10, 154, 88)
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 10, 154, 88, 15)
    Wait(6)
    Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, -10, 154, 88)
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, -10, 154, 88, 20)
    Wait(6)
    Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 10, 154, 88)
    PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 10, 154, 88, 25)
    Wait(6)
    Call(SetPlayerAnimation, ANIM_Mario1_UsePower)
    Loop(3)
        Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 0, 154, 88)
        PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 0, 154, 88, 30)
        Wait(6)
        Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, -10, 154, 88)
        PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, -10, 154, 88, 30)
        Wait(6)
        Call(PlaySoundAt, SOUND_SEQ_STAR_SPIRIT_CAST, SOUND_SPACE_DEFAULT, 10, 154, 88)
        PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, 10, 154, 88, 30)
        Wait(6)
