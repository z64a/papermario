...
EvtScript N(EVS_Init) = {
    ...
    Call(SetEnemyHP, ACTOR_SELF, GB_FinalBowserHP)
    IfLt(GB_FinalBowserHP, 1)
    ...
    Switch(LVar0)
        ...
        CaseEq(PHASE_ENEMY_BEGIN)
            ...
            IfLt(LVar0, 50)
                ...
                IfNotFlag(LVar0, AVAL_Flag_NotOverYet)
                    BitwiseOrConst(LVar0, AVAL_Flag_NotOverYet)
...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseEq(EVENT_PEACH_BEAM)
            ...
            Call(SetPartEventBits, ACTOR_SELF, PRT_MAIN, ACTOR_EVENT_FLAG_STAR_ROD_ENCHANTED, false)
            Call(SetActorVar, ACTOR_SELF, AVAR_TurnsSinceStarBeam, 0)
            ...
            Call(GetActorVar, ACTOR_SELF, AVAR_Flags, LVar0)
            IfNotFlag(LVar0, AVAL_Flag_PeachBeamRemark)
                BitwiseOrConst(LVar0, AVAL_Flag_PeachBeamRemark)
                Call(SetActorVar, ACTOR_SELF, AVAR_Flags, LVar0)
                Call(GetStatusFlags, ACTOR_SELF, LVar3)
                IfNotFlag(LVar3, STATUS_FLAG_SHRINK)
                    Set(LVar3, 90)
...
EvtScript N(EVS_Death) = {
    ...
    EndIf
    Wait(30)
    Call(PlaySoundAtActor, ACTOR_SELF, SOUND_BOWSER_POWER_DOWN)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_BattleBowser_Hurt)
    Thread
        Call(MakeLerp, 0, 80, 8, EASING_QUADRATIC_OUT)
        Set(LVar2, 0)
        Label(0)
        Call(UpdateLerp)
        Label(1)
        IfGe(LVar2, LVar0)
            ...
            Call(GetActorScale, ACTOR_SELF, LVar6, LVar6, LVar7)
            Call(N(MakeLightningBolts), LVar3, LVar4, LVar5, LVar6)
            IfEq(LVar1, 1)
                Goto(0)
            EndIf
        Else
    ...
    Thread
        ...
        IfNotFlag(LVarA, STATUS_FLAG_SHRINK)
            Add(LVar1, 60)
        Else
            Add(LVar1, 24)
        EndIf
    ...
    Call(MakeLerp, 0, 0x00001950, 100, EASING_COS_IN_OUT)
    Label(2)
    Call(UpdateLerp)
    Mod(LVar0, 360)
    ...
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_BattleBowser_HurtStill)
    Wait(15)
    Call(PlaySoundAtActor, ACTOR_SELF, SOUND_BOWSER_COLLAPSE)
    Call(SetAnimation, ACTOR_SELF, PRT_MAIN, ANIM_BattleBowser_DefeatedIdle)
    Thread
    ...
    Call(SetPartScale, ACTOR_SELF, PRT_MAIN, Float(1.1), Float(0.93), Float(1.0))
    Wait(1)
    Call(SetPartScale, ACTOR_SELF, PRT_MAIN, Float(1.2), Float(0.85), Float(1.0))
    Wait(1)
    Call(SetPartScale, ACTOR_SELF, PRT_MAIN, Float(1.25), Float(0.8), Float(1.0))
    Wait(1)
    Call(SetPartScale, ACTOR_SELF, PRT_MAIN, Float(1.3), Float(0.75), Float(1.0))
    Wait(1)
    Call(SetPartScale, ACTOR_SELF, PRT_MAIN, Float(1.2), Float(0.87), Float(1.0))
    Wait(1)
    Call(SetPartScale, ACTOR_SELF, PRT_MAIN, Float(1.1), Float(0.9201), Float(1.0))
    Wait(1)
...
EvtScript N(EVS_Recover) = {
    ...
    IfNotFlag(LVar3, STATUS_FLAG_SHRINK)
        ...
        Add(LVar1, 135)
        Sub(LVar2, 3)
        PlayEffect(EFFECT_ENERGY_IN_OUT, FX_ENERGY_IN_YELLOW_POINTS, LVar0, LVar1, LVar2, Float(1.5), 50, 0)
        Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
        Add(LVar0, 22)
        Sub(LVar2, 3)
    ...
    Else
        ...
        Add(LVar1, 54)
        Sub(LVar2, 3)
        PlayEffect(EFFECT_ENERGY_IN_OUT, FX_ENERGY_IN_YELLOW_POINTS, LVar0, LVar1, LVar2, Float(0.6), 50, 0)
        Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
        Add(LVar0, 9)
        Sub(LVar2, 3)
...
EvtScript N(EVS_UseDrainingShockwave) = {
    ...
    Call(RemovePlayerBuffs, PLAYER_BUFF_ALL)
    Switch(LVarF)
        CaseOrEq(HIT_RESULT_HIT)
        CaseOrEq(HIT_RESULT_NO_DAMAGE)
        CaseOrEq(HIT_RESULT_10)
