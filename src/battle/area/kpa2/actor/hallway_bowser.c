...
EvtScript N(EVS_HandleEvent) = {
    ...
    Switch(LVar0)
        ...
        CaseEq(EVENT_STAR_BEAM)
            ...
            Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            Add(LVar1, LVar3)
            PlayEffect(EFFECT_SPARKLES, FX_SPARKLES_STAR, LVar0, LVar1, LVar2, 50, 0)
            Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
            Add(LVar1, LVar4)
...
EvtScript N(EVS_Recover) = {
    ...
    IfNotFlag(LVar3, STATUS_FLAG_SHRINK)
        ...
        Add(LVar1, 90)
        Sub(LVar2, 3)
        PlayEffect(EFFECT_ENERGY_IN_OUT, FX_ENERGY_IN_YELLOW_POINTS, LVar0, LVar1, LVar2, Float(1.0), 50, 0)
        Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
        Add(LVar0, 15)
        Sub(LVar2, 3)
    ...
    Else
        ...
        Add(LVar1, 36)
        Sub(LVar2, 3)
        PlayEffect(EFFECT_ENERGY_IN_OUT, FX_ENERGY_IN_YELLOW_POINTS, LVar0, LVar1, LVar2, Float(0.4), 50, 0)
        Call(GetActorPos, ACTOR_SELF, LVar0, LVar1, LVar2)
        Add(LVar0, 6)
        Sub(LVar2, 3)
