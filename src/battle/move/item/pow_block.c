...
EvtScript N(EVS_UseItem) = {
    ...
    PlayEffect(EFFECT_WALKING_DUST, FX_DUST_2, -40, 60, 20, 0, 0, 0)
    PlayEffect(EFFECT_WALKING_DUST, FX_DUST_2, -30, 65, 20, 0, 0, 0)
    PlayEffect(EFFECT_WALKING_DUST, FX_DUST_2, -40, 60, 20, 0, 0, 0)
    PlayEffect(EFFECT_WALKING_DUST, FX_DUST_2, -40, 55, 20, 0, 0, 0)
    ...
    Label(0)
        ...
        IfNe(LVar0, ITER_NO_MORE)
            Goto(0)
        EndIf
    PlayEffect(EFFECT_WALKING_DUST, FX_DUST_2, -70, 60, 20, 0, 0, 0)
    PlayEffect(EFFECT_WALKING_DUST, FX_DUST_2, -60, 65, 20, 0, 0, 0)
    PlayEffect(EFFECT_WALKING_DUST, FX_DUST_2, -70, 60, 20, 0, 0, 0)
    PlayEffect(EFFECT_WALKING_DUST, FX_DUST_2, -70, 55, 20, 0, 0, 0)
