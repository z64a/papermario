...
EvtScript N(EVS_Attack_Bomb) = {
    ...
    Switch(LVar2)
        CaseEq(MOVE_BOMB)
            Call(action_command_bomb_start, 0, 57 * DT, AC_DIFFICULTY_STANDARD, ACV_BOMB_BASIC)
        CaseEq(MOVE_POWER_BOMB)
            Call(action_command_bomb_start, 0, 73 * DT - 1, AC_DIFFICULTY_STANDARD, ACV_BOMB_SUPER)
        CaseEq(MOVE_MEGA_BOMB)
            Call(action_command_bomb_start, 0, 87 * DT, AC_DIFFICULTY_STANDARD, ACV_BOMB_ULTRA)
    EndSwitch
